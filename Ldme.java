...
public class Ldme {
 ...
 //    }
    ...
    void drop() {
        ...
        System.out.println("Drop Compression: " + (1 - (P.size() + Cp_0.size() + Cm_0.size() * 1.0)/(Gr.numArcs() * 1.0)));
    }
	...
	void evaluateCompression() {
        ...
        System.out.println("Number of Edges Original:   " + Gr.numArcs());
        System.out.println("Compression: " + (1 - (P.size() + Cp_0.size() + Cm_0.size() * 1.0)/(Gr.numArcs()  * 1.0)));
	}
